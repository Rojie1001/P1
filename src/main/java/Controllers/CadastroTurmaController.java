...
public class CadastroTurmaController implements Initializable, InterfaceTherad {
	...
	void Envio(ActionEvent event) throws IOException {
		...
		controller.conectar("novaturma@"+txtNomeTurma.getText().toString() + "-" + txtProfessorResp.getText().toString());
